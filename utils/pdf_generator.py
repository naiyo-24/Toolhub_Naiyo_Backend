...
def generate_case_report(case_id: int, db: Session) -> str:
    ...
    # --- HEADER ---
    elements.append(Paragraph("LOAN DESK", title_style))
    elements.append(Paragraph(f"Comprehensive Case Report", ParagraphStyle('Sub', parent=styles['Heading2'], alignment=1)))
